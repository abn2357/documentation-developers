---
title: tronweb object
excerpt: >-
  Create an instance of the tronWeb javascript library. In addition to the
  utility functions, it includes all related modules.
deprecated: false
hidden: true
metadata:
  title: ''
