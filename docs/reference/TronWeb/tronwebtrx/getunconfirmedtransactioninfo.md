---
title: getUnconfirmedTransactionInfo
excerpt: >-
  Gets the details for an unconfirmed transaction by txid, including the fees
  and virtual machine events for an unconfirmed transaction.
deprecated: false
hidden: true
metadata:
  title: ''
