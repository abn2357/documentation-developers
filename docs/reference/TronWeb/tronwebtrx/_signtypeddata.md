---
title: _signTypedData
excerpt: >-
  Sign the typed data `value` with `types` data structure for `domain` using the
  [TIP-712 specification](https://github.com/tronprotocol/tips/issues/443).
deprecated: false
hidden: true
metadata:
  title: ''
