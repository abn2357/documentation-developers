...
excerpt: >-
  Returns the  transaction info: receipt, transaction fee, block height ... by
  transaction hash. Please refer to http api:
  [wallet/gettransactioninfobyid](https://developers.tron.network/reference/gettransactioninfobyid)
deprecated: false
hidden: false
metadata:
  title: ''
...
* `object` - A transaction receipt object, or null when no receipt was found. The items in the transaction receipt are as below.
