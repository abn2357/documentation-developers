...
* `trxHash` &lt;String&gt; The hash value of the transaction for the main-chain deployment TRC20 contract.
...
const txID = await tronWeb.sidechain.mappingTrc20(trxHash, mappingFee, feeLimit);
```