...
An account loses the TP after release(unstake) the staked TRX, and votes for the ongoing and future round are invalid unless stake TRX to get TP again. 
...
Voter Rewards:\
votes *x* 80% *x* 28800(blocks/day) *x*（ 160/ total votes +  16 / 27 */*  sr votes ）

***Take one of the super representative candidate from 28 to 127 as an example***

![1178](https://files.readme.io/de25852-c41a9cf-Foxmail20191101113132.png "c41a9cf-Foxmail20191101113132.png")
...
Voter Rewards:\
votes *x* 80% *x* 28800(blocks/day) \_x\_160/ total votes
...
[Update brokerage](ref:wallet-updatebrokerage)

[Query SR brokerage ratio](ref:wallet-getbrokerage)

[Query user reward](ref:wallet-getreward)

[Withdraw balance](ref:withdrawbalance)
